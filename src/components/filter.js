  ...
  getTemplate() {
    return `<form class="trip-filters" action="#" method="get">
        ...
        <div class="trip-filters__filter">
          <input id="filter-everything" data-filter-type="default" class="trip-filters__filter-input  visually-hidden" type="radio" name="trip-filter" value="everything" checked>
